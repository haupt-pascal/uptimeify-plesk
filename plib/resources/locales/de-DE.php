...
$messages = [
    ...
    'dashboard.statusInactive'    => 'Inaktiv',
    'dashboard.statusMaintenance' => 'Wartung',
    'dashboard.enable'        => 'Aktivieren',
    'dashboard.ignore'        => 'Ignorieren',
    'dashboard.unignore'      => 'Nicht mehr ignorieren',
    'dashboard.ignoredBadge'  => '(ignoriert)',
    'dashboard.previewBadge'  => '(Plesk-Preview-Domain)',
    'dashboard.ignoredMsg'    => '%%domain%% wird künftig vom Sync ausgeschlossen.',
    'dashboard.unignoredMsg'  => '%%domain%% wird wieder synchronisiert.',
    ...
    'settings.brandName'        => 'Marken-Name (Whitelabel)',
    'settings.brandNameHint'    => 'Wird im Plesk-Startseiten-Widget und in den Seitentiteln statt „Uptimeify" angezeigt. Leer lassen für den Standard.',
    ...
    'widget.open'          => 'Öffne %%brand%%, um deine Domains zu synchronisieren.',
    'widget.openButton'    => '%%brand%% öffnen',
    'widget.statMonitors'  => 'Monitore',
    'widget.statAttention' => 'Brauchen Aufmerksamkeit',
    'widget.statIncidents' => 'Offene Vorfälle',
    'widget.scope'         => 'Über dein gesamtes %%brand%%-Konto.',
    'widget.serverTitle'   => '%%brand%% — dieser Server',
    'widget.serverOpen'    => 'Öffne einmal das Dashboard, um die Statistik dieses Servers zu laden.',
    'widget.serverCoverage' => '%%monitored%% von %%total%% Domains dieses Servers werden überwacht.',
    'widget.statMonitored' => 'Überwacht',
